...
A C++ implementation of core linear algebra operations: matrix multiplication, matrix addition, transpose, and scalar multiplication that are designed for square matrices.
